...
const allTemplates = [
  ...
  { name: "Grain", category: "Services", color: "from-yellow-600 to-amber-700", path: "/afrify/templates/services/grain", price: "Paid" },
  { name: "Smile Hub", category: "Services", color: "from-teal-400 to-emerald-500", path: "/afrify/templates/services/smile", price: "Paid" },
  { name: "Panorama", category: "Services", color: "from-indigo-400 to-purple-600", path: "/afrify/templates/services/panorama", price: "Paid" },
  { name: "Printing", category: "Services", color: "from-orange-400 to-red-500", path: "/afrify/templates/services/printing", price: "Paid" },
  { name: "Sonik", category: "Services", color: "from-fuchsia-500 to-pink-600", path: "/afrify/templates/services/sonik", price: "Paid" },
  { name: "Leap", category: "Services", color: "from-green-400 to-teal-500", path: "/afrify/templates/services/leap", price: "Paid" },
  { name: "Aircon", category: "Services", color: "from-sky-400 to-blue-500", path: "/afrify/templates/services/aircon", price: "Paid" },
  { name: "Enthusiast", category: "Services", color: "from-red-500 to-orange-500", path: "/afrify/templates/services/enthusiast", price: "Paid" },
  { name: "Tattoo Studio", category: "Services", color: "from-gray-700 to-black", path: "/afrify/templates/services/tattoo", price: "Paid" },
];
