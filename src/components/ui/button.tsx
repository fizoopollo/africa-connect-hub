  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        hero: "bg-hero-gradient text-primary-foreground shadow-glow-primary hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        heroOutline: "border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground",
        orange: "bg-orange-gradient text-secondary-foreground shadow-glow-orange hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        gold: "bg-accent text-accent-foreground shadow-glow-gold hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
